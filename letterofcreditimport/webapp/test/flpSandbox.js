		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zmgproeximletterofcreditimport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmgproeximletterofcreditimport-display": {
								"semanticObject": "zmgproeximletterofcreditimport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmg.pro.exim.letterofcreditimport",
									"url": sap.ui.require.toUrl("zmg/pro/exim/letterofcreditimport")
								}
							}
						}
					}

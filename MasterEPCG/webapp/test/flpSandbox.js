		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master EPCG Import",
									"targetURL": "#zmgpromasterepcgexim-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmgpromasterepcgexim-display": {
								"semanticObject": "zmgpromasterepcgexim",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmg.pro.master.epcg.exim",
									"url": sap.ui.require.toUrl("zmg/pro/master/epcg/exim")
								}
							}
						}
					}

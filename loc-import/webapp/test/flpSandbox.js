		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Letter Of Credit - Import",
									"targetURL": "#zproskmittalcoineximlocimportlocimport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zproskmittalcoineximlocimportlocimport-display": {
								"semanticObject": "zproskmittalcoineximlocimportlocimport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpro.sk.mittalcoin.exim.loc.import.locimport",
									"url": sap.ui.require.toUrl("zpro/sk/mittalcoin/exim/loc/import/locimport")
								}
							}
						}
					}

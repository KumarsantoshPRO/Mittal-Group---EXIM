		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Print PDF",
									"targetURL": "#zmceximproskzproprintpdfzproprintpdf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmceximproskzproprintpdfzproprintpdf-display": {
								"semanticObject": "zmceximproskzproprintpdfzproprintpdf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmc.exim.pro.sk.zproprintpdf.zproprintpdf",
									"url": sap.ui.require.toUrl("zmc/exim/pro/sk/zproprintpdf/zproprintpdf")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zmceximprozproprintcheque-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmceximprozproprintcheque-display": {
								"semanticObject": "zmceximprozproprintcheque",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmc.exim.pro.zproprintcheque",
									"url": sap.ui.require.toUrl("zmc/exim/pro/zproprintcheque")
								}
							}
						}
					}

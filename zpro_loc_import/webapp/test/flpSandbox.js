		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zmgproeximzprolocimport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmgproeximzprolocimport-display": {
								"semanticObject": "zmgproeximzprolocimport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmg.pro.exim.zprolocimport",
									"url": sap.ui.require.toUrl("zmg/pro/exim/zprolocimport")
								}
							}
						}
					}

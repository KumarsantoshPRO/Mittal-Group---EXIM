		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmceximproskzprolocexport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmceximproskzprolocexport-display": {
								"semanticObject": "zmceximproskzprolocexport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmc.exim.pro.sk.zprolocexport",
									"url": sap.ui.require.toUrl("zmc/exim/pro/sk/zprolocexport")
								}
							}
						}
					}

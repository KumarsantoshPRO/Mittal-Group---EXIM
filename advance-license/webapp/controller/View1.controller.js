sap.ui.define([
    ...
    function (Controller, JSONModel, Filter, FilterOperator, Engine, SelectionController, SortController, GroupController, MetadataHelper, Sorter, CoreLibrary, ColumnWidthController, FilterController, Spreadsheet, exportLibrary) {
        "use strict";
        var EdmType = exportLibrary.EdmType;

        return Controller.extend("zpro.sk.mittalcoin.exim.advance.license.advancelicense.controller.View1", {
            onInit: function () {
            ...
            getCallForTable: function (aFilters) {
                ...
                this.getOwnerComponent().getModel().read(sPath, {
                    ...
                    success: function (Data) {
                        ...
                        var heading = "Advance License";
                        if (Number(Data.results.length) > 0) {
                            heading = "Advance License(" + Data.results.length + ")"
            ...
            onAdvanceLicenseValuelHelp: function () {
                if (!this.AdvanceLicenseFrag) {
                    this.AdvanceLicenseFrag = sap.ui.xmlfragment(
                        "zpro.sk.mittalcoin.exim.advance.license.advancelicense.view.fragments.View1.valueHelps.valueHelp_AdvanceLicense",
                        this
                    );
            ...
            onCompanyCodeValuelHelp: function () {
                if (!this.CompanyCodeFrag) {
                    this.CompanyCodeFrag = sap.ui.xmlfragment(
                        "zpro.sk.mittalcoin.exim.advance.license.advancelicense.view.fragments.View1.valueHelps.valueHelp_CompanyCode",
                        this
                    );
            ...
            onPlantValuelHelp: function () {
                if (!this.PlantFrag) {
                    this.PlantFrag = sap.ui.xmlfragment(
                        "zpro.sk.mittalcoin.exim.advance.license.advancelicense.view.fragments.View1.valueHelps.valueHelp_Plant",
                        this
                    );
            ...
            // On click of Advance License item

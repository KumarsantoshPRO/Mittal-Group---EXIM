		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zproskmittalcoineximadvancelicenseadvancelicense-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zproskmittalcoineximadvancelicenseadvancelicense-display": {
								"semanticObject": "zproskmittalcoineximadvancelicenseadvancelicense",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zpro.sk.mittalcoin.exim.advance.license.advancelicense",
									"url": sap.ui.require.toUrl("zpro/sk/mittalcoin/exim/advance/license/advancelicense")
								}
							}
						}
					}

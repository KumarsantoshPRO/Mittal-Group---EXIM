		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PDF",
									"targetURL": "#zgmproeximpdfprintpdf-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgmproeximpdfprintpdf-display": {
								"semanticObject": "zgmproeximpdfprintpdf",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgm.pro.exim.pdfprint.pdf",
									"url": sap.ui.require.toUrl("zgm/pro/exim/pdfprint/pdf")
								}
							}
						}
					}
